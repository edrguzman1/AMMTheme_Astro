<?php 
/* Template Name: Detalle de software Dinámico */
get_header(); 
?>
...
<main class="pt-32 pb-20 bg-white">
    <div class="container mx-auto px-4 max-w-7xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div class="space-y-8">
                <div>
                    <span class="inline-block px-3 py-1 rounded-full bg-sky-50 text-sky-600 text-xs font-bold tracking-wider uppercase mb-4">Solución Empresarial</span>
        ...
        <section class="mt-32 p-12 bg-blue-50 rounded-3xl text-center">
            ...
            <p class="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">Somos expertos en la integración de software corporativo. Contáctanos para recibir asesoría personalizada sobre qué equipo se adapta mejor a tu flujo operativo.</p>
